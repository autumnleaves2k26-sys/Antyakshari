...
var createRegistrationBodyNameMin = 2;
var createRegistrationBodyPhoneMin = 10;
var createRegistrationBodyTotalPassesMax = 10;
var createRegistrationBodyParticipantsItemParticipantNameMin = 2;
var createRegistrationBodyParticipantsItemPhoneMin = 10;
var CreateRegistrationBody = objectType({
  "name": stringType().min(createRegistrationBodyNameMin),
  "email": stringType().email(),
  "phone": stringType().min(createRegistrationBodyPhoneMin),
  "totalPasses": numberType().min(1).max(createRegistrationBodyTotalPassesMax),
  "participants": arrayType(objectType({
    "participantName": stringType().min(createRegistrationBodyParticipantsItemParticipantNameMin),
    "email": stringType().email(),
    "phone": stringType().min(createRegistrationBodyParticipantsItemPhoneMin)
  }))
});
var GetRegistrationParams = objectType({
  "bookingId": coerce.string()
});
var GetRegistrationResponse = objectType({
  "id": numberType(),
  "bookingId": stringType(),
  "name": stringType(),
  "email": stringType(),
  "phone": stringType(),
  "totalPasses": numberType(),
  "paymentScreenshot": stringType().nullish(),
  "paymentStatus": enumType(["pending", "approved", "rejected"]),
  "createdAt": stringType(),
  "participants": arrayType(objectType({
    "id": numberType(),
    "registrationId": numberType(),
    "participantName": stringType(),
    "email": stringType().nullish(),
    "phone": stringType().nullish(),
    "age": numberType().nullish(),
    "collegeOrCompany": stringType().nullish(),
    "passId": stringType().nullish(),
    "qrToken": stringType().nullish(),
    "isUsed": booleanType().optional()
  }))
});
var UploadPaymentScreenshotParams = objectType({
  "bookingId": coerce.string()
});
var UploadPaymentScreenshotBody = objectType({
  "screenshotFileName": stringType(),
  "screenshotMimeType": stringType(),
  "screenshotData": stringType()
});
var UploadPaymentScreenshotResponse = objectType({
  "id": numberType(),
  "bookingId": stringType(),
  "name": stringType(),
  "email": stringType(),
...
var AdminLoginBody = objectType({
  "password": stringType()
});
var AdminLoginResponse = objectType({
  "success": booleanType(),
  "token": stringType()
});
var ListRegistrationsQueryParams = objectType({
  "status": enumType(["pending", "approved", "rejected"]).optional()
});
var ListRegistrationsResponseItem = objectType({
  "id": numberType(),
  "bookingId": stringType(),
  "name": stringType(),
  "email": stringType(),
...
var ListRegistrationsResponse = arrayType(ListRegistrationsResponseItem);
var ApproveRegistrationParams = objectType({
  "id": coerce.number()
});
var ApproveRegistrationResponse = objectType({
  "id": numberType(),
  "bookingId": stringType(),
  "name": stringType(),
  "email": stringType(),
...
var RejectRegistrationParams = objectType({
  "id": coerce.number()
});
var RejectRegistrationResponse = objectType({
  "id": numberType(),
  "bookingId": stringType(),
  "name": stringType(),
  "email": stringType(),
...
var GetAdminStatsResponse = objectType({
  "totalRegistrations": numberType(),
  "pendingRegistrations": numberType(),
  "approvedRegistrations": numberType(),
  "rejectedRegistrations": numberType(),
  "totalPasses": numberType(),
  "totalPassesIssued": numberType()
});
var ValidatePassParams = objectType({
  "qrToken": coerce.string()
});
var ValidatePassResponse = objectType({
  "status": enumType(["valid", "used", "invalid"]),
  "passId": stringType().nullable(),
  "participantName": stringType().nullable(),
  "eventName": stringType(),
  "eventDate": stringType(),
  "isUsed": booleanType().optional()
});
var MarkPassUsedParams = objectType({
  "qrToken": coerce.string()
});
var MarkPassUsedResponse = objectType({
  "status": enumType(["valid", "used", "invalid"]),
  "passId": stringType().nullable(),
  "participantName": stringType().nullable(),
  "eventName": stringType(),
